#!/usr/bin/env python3
"""
Database migration script to add Lean verification fields to processing_status table.
Adds: verification_status, verification_has_errors, verification_has_warnings,
      verification_messages, verification_error, verification_time,
...
def migrate_database(db_path: str = '/datadisk/Web2Lean/data/databases/web2lean.db'):
    """
    Add verification columns to processing_status table.
    ...
    try:
        ...
        columns_to_add = {
            ...
            'verification_has_errors': 'BOOLEAN DEFAULT 0',
            'verification_has_warnings': 'BOOLEAN DEFAULT 0',
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Migrate database to add verification fields')
