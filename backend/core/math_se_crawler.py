"""
Math StackExchange Crawler
Crawles mathematical questions and answers from math.stackexchange.com
"""
import json
import time
import requests
...
class MathSECrawler(BaseCrawler):
    """
    Crawler for Math StackExchange (https://math.stackexchange.com).
    ...
    def fetch_questions_page(self, page: int) -> List[Dict[str, Any]]:
        """
        Fetch a page of questions from Math StackExchange API.
    ...
    def fetch_answers(self, question_id: int) -> List[Dict[str, Any]]:
        ...
        Note: In Math SE crawler, answers are included in the question API response
    ...
    def _run_crawl(self, mode: str, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional parameters
        """
        start_page = 1  # Math SE API uses 1-indexed pages
